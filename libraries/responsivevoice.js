...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice);
  ...
  a.responsivevoices = [{
   ...
   flag: "es",
   gender: "f",
   voiceIDs: [19, 16, 17, 18, 20, 76, 174, 207,
    15
   ]
  }, {
  ...
  a.speak = function(b, c, e) {
   ...
   if (b.length > a.CHARACTER_LIMIT) {
    for (var d = b; d.length > a.CHARACTER_LIMIT;) {
     ...
     var g = "";
     if (-1 ==
      b || b >= a.CHARACTER_LIMIT) b = d.search(/[,]+/); - 1 == b && -1 == d.search(" ") && (b = 99);
   ...
   d = {};
   if (null != b.mappedProfile) d = b.mappedProfile;
   else if (d.systemvoice = a.getMatchedVoice(b), d.collectionvoice = {},
    null == d.systemvoice) {
  ...
  a.startTimeout = function(b, c) {
   ...
   null == a.msgprofile.collectionvoice.timerSpeed &&
    (e = 1);
   if (!(0 >= e)) {
    var f = b.split(/\s+/).length,
     d = (b.match(/[^ ]/igm) || b).length / f / 5.1,
     e = 60 / a.WORDS_PER_MINUTE * e * 1E3 * d * f;
    3 > f && (e = 4E3);
    3E3 > e && (e = 3E3);
